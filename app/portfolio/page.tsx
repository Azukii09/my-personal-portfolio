        ...
        <div className={"w-full"}>
            ...
            <div className={"w-full my-12 flex flex-wrap flex-col md:flex-row"}>
                <div className={"w-full md:w-1/2 aspect-square"}>
                    <div className="aspect-square m-3 relative flex flex-col justify-center overflow-hidden bg-gray-50" onClick={() => setModal(true)}>
                        ...
                        <div
                            ...
                            <div className="max-h-full w-full max-w-6xl overflow-y-auto sm:rounded-2xl bg-white relative">
                                <div className={"w-full flex flex-row-reverse"}>
                                    <div className={"cursor-pointer flex items-center justify-center rounded-full m-5"} onClick={() => setModal(false)}>
                                        <Image src={"/assets/img/close.png"} alt={"close"} width={35} height={35} />
                                    </div>
                                </div>
                                <div className="w-full">
                                    <div className="m-8 my-20 max-w-3xl mx-auto">
                                        <div className="mb-8">
                                        ...
                                        <div className="space-y-4">
                                            <button
                                                className="p-3 bg-black rounded-full text-white w-full font-semibold">Allow
                                                notifications
                                            </button>
                                            <button
                                                className="p-3 bg-white border rounded-full w-full font-semibold" onClick={() => setModal(false)}>Skip
                                                for now
                                            </button>
                                        </div>
                                    </div>
